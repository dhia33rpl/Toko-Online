...
export default function FormEditProduct({ product }: Props) {
  ...
  return (
    <form
      ...
      className="space-y-4 max-w-lg mx-auto bg-white p-6 rounded-xl shadow-md"
    >
      <h1 className="text-2xl font-bold text-rose-500">Edit Product</h1>
      ...
      <button
        type="submit"
        className="w-full bg-rose-400 hover:bg-rose-500 text-white py-2 rounded-lg"
      >
        Update Product
      </button>
    </form>
